...
# =============
# job_id=12878111
# log_file_path = File.expand_path(File.join('..','json_files','233.log', File.dirname(__FILE__)))
# DownloadJobs.download_job(job_id,log_file_path)
...
#=================
# json_files_path = File.expand_path(File.join('..', '..', '..', 'bodyLog2', 
#         'json_files','711.log'), File.dirname(__FILE__))
# repos='ome/bioformats'
# repository = Travis::Repository.find(repos)
# job=Travis::Job.find(711739769)
# job.log.body { |chunk| File.open(json_files_path, 'w') do |file|
#     file.puts(chunk) end}